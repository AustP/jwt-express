...
*key* - This is they key used to look up the value in the payload. If only this value is passed to `jwt.require()`, then the middleware function will check that the value is truthy.
